...
まず、 `ojosama` はにじさんじ所属の壱百満天原サロメお嬢様のキャラクターを題材にした二次創作の一つですわ。
...
次に、その変更が「壱百満天原サロメお嬢様の口調の再現に必要な変更かどうか」を確認いたしますわ。
...
## :white_check_mark: レビューワー用のおチェックリスト

レビューワーは以下チェックリストを確認してくださいまし。
